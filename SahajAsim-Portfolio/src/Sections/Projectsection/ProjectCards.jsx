...
const ProjectCards = () => {
  return (
    <>
     <div className='h-85 border border-gray-800 bg-slate-950/60 w-60 flex flex-col gap-3 p-2 rounded-xl hover:scale-102 transition-transform cursor-pointer'>
      ...
      <h3 className='font-bold text-xl '>🛠️ Full-Stack Project(in progress)</h3>
      <p className='text-gray-300 text-xs'>Currently building a full-stack application using modern web technologies</p>
      ...
      <h4 className='bg-gray-600 rounded px-1 border-none text-xs  flex items-center '>NodeJs</h4>
      <h4 className='bg-gray-600 rounded px-1 border-none text-xs  flex items-center ' >MongoDB</h4>
