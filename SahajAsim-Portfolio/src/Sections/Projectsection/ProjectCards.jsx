...
const ProjectCards = () => {
  return (
    <>
     <div className='h-80 border-1 border-gray-800 bg-slate-950/60 w-60 flex flex-col gap-3 p-2 rounded-xl hover:scale-102 transition-transform cursor-pointer'>
      ...
      <div className='flex gap-2 text-white font-semibold flex flex-wrap '>
